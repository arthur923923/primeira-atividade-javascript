alert("bem vindo ao frances burguer")
let lanche = prompt("qual lanche vc quer ?    " + " x-bacon " +" x-tudo " +
    " x-ratão "
) 
let fritas = prompt(" acampanha fritas ?")

let bebidas = prompt("qual bebida vc quer ?   " + " agua " +"coca "+ "cerveja")
